    ...
    <div class="flex-grow flex flex-col items-center justify-center">
        ...
        <?php if(isset($downloadLinks)): ?>
            <div class="button-container flex flex-col items-center space-y-2">
                <a href="<?php echo e(asset($mp3TrimmedFile)); ?>" download="Ringtone_Android.mp3" class="gradient-button android py-2 rounded w-full text-center">Android</a>
            </div>
        <?php endif; ?>
        ...
        <div class="mt-4">
            <?php if(isset($downloadLinks)): ?>
                <div class="button-container flex flex-col items-center space-y-2">
                    <a href="<?php echo e(url('/download-m4r')); ?>" download class="gradient-button apple py-2 rounded w-full text-center">iPhone</a>
                </div>
            <?php endif; ?>
        </div>
    ...
    <ul class="space-y-2 text-center">
        ...
        <?php $__currentLoopData = $recentRingtones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ringtone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="text-gray-200">
                <a href="<?php echo e(asset($ringtone->file_path)); ?>" class="footer-link">
                    <?php echo e($ringtone->file_name); ?>
