...
<body>
        ...
        <?php if(isset($downloadLinks)): ?>
            <div class="button-container flex flex-col items-center space-y-2 max-w-xs mx-auto">
                <a href="<?php echo e(asset($mp3TrimmedFile)); ?>" download="Android_Ringtone.mp3">
                    <img src="https://pub-c1de1cb456e74d6bbbee111ba9e6c757.r2.dev/IcSharpAndroid.png" width="80px" height="auto">
                </a>
...
<br />
        <div class="mt-4">
            <?php if(isset($downloadLinks)): ?>
                <div class="button-container flex flex-col items-center space-y-2 max-w-xs mx-auto">
                    <a href="<?php echo e(url('/download-m4r')); ?>" download="iPhone_Ringtone.m4r">
                        <img src="https://pub-c1de1cb456e74d6bbbee111ba9e6c757.r2.dev/FileIconsApple.png" width="80px" height="auto">
                    </a>
